           ...
           <div class="tab-content">
               ...
               <form action="register" method="post">
               	 ...
               	 <div class="input_div"  style="width:200px;">
               	 	<i class="fa fa-lock"></i>
               	 	<input id="validateCode" onblur="checkImg(this.value)" name="validateCode"
               	 	type="text" value="" placeholder="请输入验证码" style="width:165px;">
               	 	<label id="warning_checkcode" style="color:red"></label>
               	 	<span class="y_yzimg"><img id="codeValidateImg"  onClick="javascript:flushValidateCode();"/></span>
					<p class="y_change" style="float:right"><a href="javascript:flushValidateCode();"  >
					换一张</a></p>
					
               	 </div>
                 <button class="login-btn" style="margin:20px 0">注册</button>
               </form>
           	</div>
           </div>
